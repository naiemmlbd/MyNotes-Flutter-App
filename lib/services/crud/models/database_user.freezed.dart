...
class __$$_DatabaseUserCopyWithImpl<$Res>
    extends _$DatabaseUserCopyWithImpl<$Res, _$_DatabaseUser>
...
class _$_DatabaseUser implements _DatabaseUser {
  const _$_DatabaseUser({required this.id, required this.email});
...
abstract class _DatabaseUser implements DatabaseUser {
  const factory _DatabaseUser(
      {required final int id, required final String email}) = _$_DatabaseUser;
